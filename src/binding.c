  ...
  for( ; pass<2; pass++ ) {
    ...
    while( curr_eb != NULL ) {
      ...
      if( curr_eb->stmt_id == 0 ) {
        ...
        /* If the current expression has already been bound to a signal, don't bind it again */
...
/* 
 $Log$
 Revision 1.102.2.1  2007/09/05 21:15:50  phase1geo
 Fixing bug 1788991.  Full regression passes.
