...
/*! Used for storing 2 or 4-state value-only values (no coverage information stored) in 32-bit values */
#define VTYPE_VAL_U32   0

/*! Used for storing 2 or 4-state signal values in 32-bit values */
#define VTYPE_SIG_U32   1

/*! Used for storing 2 or 4-state expression values in 32-bit values */
#define VTYPE_EXP_U32   2

/*! Used for storing 2 or 4-state memory information in 32-bit values */
#define VTYPE_MEM_U32   3
...
/*! Stores simple value (no coverage information) in 32-bit unsigned integers */
struct vdata_val_u32 {
  uint32 valL;                       /*!< Contains 2-state information */
  uint32 valH;                       /*!< Contains X/Z information */
};

/*! Stores signal value in 32-bit unsigned integers */
struct vdata_sig_u32 {
  uint32 valL;
  uint32 valH;
  uint32 tog01;
  uint32 tog10;
...
/*! Stores expression value in 32-bit unsigned integers */
struct vdata_exp_u32 {
  uint32 valL;
  uint32 valH;
  uint32 eval_a;
  uint32 eval_b;
...
/*! Stores memory value in 32-bit unsigned integers */
struct vdata_mem_u32 {
  uint32 valL;
  uint32 valH;
  uint32 tog01;
  uint32 tog10;
...
struct vector_s {
  ...
  union {
    ...
    struct {
      nibble type      :5;           /*!< Specifies what type of information is stored in this vector
  ...
  union {
    vdata_val_u32* u32_val;          /*!< 32-bit unsigned integer value to store plain value */
    vdata_sig_u32* u32_val;          /*!< 32-bit unsigned integer value to store signal value */
    vdata_exp_u32* u32_val;          /*!< 32-bit unsigned integer value to store expression value */
    vdata_mem_u32* u32_val;          /*!< 32-bit unsigned integer value to store memory value */
