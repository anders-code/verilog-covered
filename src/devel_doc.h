...
/*!
 ...
 signal structure, please refer to vsignal.c.
...
<HR>
 ...
 the detailed information section (signal = vsignal.c; expression = expr.c; statement = statement.c;
...
/*
 $Log$
 Revision 1.7.2.1  2004/04/02 19:37:45  phase1geo
