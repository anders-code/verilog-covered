...
fsm_var* fsm_var_add(
  ...
  bool        exclude      /*!< If TRUE, excludes the FSM from coverage consideration */
) { PROFILE(FSM_VAR_ADD);
...
/*
 ...
 leak issue when the profiling output file is found to be unwritable.  Other
 various coding updates.
