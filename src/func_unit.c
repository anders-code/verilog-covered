...
#ifdef DEBUG_MODE
  switch( funit->type ) {
    case FUNIT_MODULE      :  snprintf( user_msg, USER_MSG_LENGTH, "Writing module %s", obfuscate_name( funit->name, 'f' ) );       break;
    case FUNIT_NAMED_BLOCK :  snprintf( user_msg, USER_MSG_LENGTH, "Writing named block %s", obfuscate_name( funit->name, 'f' ) );  break;
    case FUNIT_FUNCTION    :  snprintf( user_msg, USER_MSG_LENGTH, "Writing function %s", obfuscate_name( funit->name, 'f' ) );     break;
    case FUNIT_TASK        :  snprintf( user_msg, USER_MSG_LENGTH, "Writing task %s", obfuscate_name( funit->name, 'f' ) );         break;
    default                :
...
void funit_display_signals( func_unit* funit ) {
  ...
  switch( funit->type ) {
    case FUNIT_MODULE      :  printf( "Module => %s\n", obfuscate_name( funit->name, 'f' ) );       break;
