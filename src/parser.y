...
description
  ...
  | K_task automatic_opt IDENTIFIER ';'
    ...
    task_item_list_opt statement_or_null
    {
      ...
      if( ignore_mode == 0 ) {
        if( stmt == NULL ) {
          stmt = db_create_statement( db_create_expression( NULL, NULL, EXP_OP_NOOP, FALSE, @7.first_line, @7.first_column, (@7.last_column - 1), NULL ), @7.ppline );
        }
  ...
  | S_signed '(' expression ')'
    {
      if( (ignore_mode == 0) && ($3 != NULL) ) {
        Try {
          $$ = db_create_expression( NULL, $3, EXP_OP_SSIGNED, lhs_mode, @1.first_line, @1.first_column, (@4.last_column - 1), NULL );
          $$->value->suppl.part.is_signed = 1;
        } Catch_anonymous {
          expression_dealloc( $3, FALSE );
          error_count++;
  ...
  | K_for inc_for_depth '(' for_initialization ';' expression ';' passign ')' statement dec_for_depth
    { PROFILE(PARSER_STATEMENT_FOR_A);
      ...
      if( (ignore_mode == 0) && ($4 != NULL) && ($6 != NULL) && ($8 != NULL) && ($10 != NULL) ) {
        block_depth++;
        stmt2 = db_create_statement( $6, @6.ppline );
  ...
  | S_srandom '(' expression_systask_list ')' ';'
    {
      if( (ignore_mode == 0) && ($3 != NULL) ) {
        Try {
          $$ = db_create_statement( db_create_expression( NULL, $3, EXP_OP_SSRANDOM, FALSE, @1.first_line, @1.first_column, (@1.last_column - 1), NULL ), @1.ppline );
        } Catch_anonymous {
          expression_dealloc( $3, FALSE );
          error_count++;
          $$ = NULL;
