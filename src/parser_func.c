...
void parser_create_task_decl(
  ...
  const char*  orig_fname,   /*!< Name of file that contains this task */
  const char*  incl_fname,   /*!< Name of file that includes this task */
...
void parser_create_function_decl(
  ...
  const char*  orig_fname,   /*!< Filename containing function */
  const char*  incl_fname,   /*!< Filename including function */
